...
# build a ggplot scatterplot with a 45 degree line and other specifications
...
print(scatter_p(df, df$mean_score, df$partial_cont,
          ...
          xlab = "Mean scores",
          "Correlation of mean scores and FS partial (cont.; M1)"))

# M_B1 vs. M2
print(scatter_p(df, df$mean_score, df$approx_cont,
          ylab = "FS approximate (continuous)",
          xlab = "Mean scores",
          "Correlation of mean scores and FS approximate (cont.; M2)"))

# M_B1 vs. M3
print(scatter_p(df, df$mean_score, df$approx_ord,
          ylab = "FS approximate (ordinal)",
          xlab = "Mean scores",
          "Correlation of mean scores and FS approximate (ordinal; M3)"))
...
print(scatter_p(df, df$partial_cont, df$partial_cont, 
          ...
          ylab = "FS approximate (continuous)",
          "Correlation of FS: partial (cont.; M1) or approximate (cont.; M2)"))
...
print(scatter_p(score_df_noNAs, as.numeric(score_df_noNAs$partial_cont), 
          ...
          xlab = "FS partial (continuous)",
          ylab = "FS approximate (continuous)",
          "[No NAs] Correlation of FS: partial (cont.; M4) or approximate (cont.; M5)"))
...
print(scatter_p(score_df_noNAs, as.numeric(score_df_noNAs$partial_ord), 
          ...
          ylab = "FS approximate (ordinal)",
          "[No NAs] Correlation of FS: partial (ord.; M6) or approximate (ord.; M7)"))
...
print(scatter_p(df, df$approx_cont,
          ...
          ylab = "FS approximate (ordinal)",
          "Correlation of FS: approximate (cont.; M2) vs. approximate (ord.; M3)"))
...
print(scatter_p(score_df_noNAs, score_df_noNAs$partial_cont,
          ...
          "[No NAs] Correlation of FS: partial (cont.; M4) or partial (ord.; M6)"))
...
print(scatter_p(score_df_noNAs, as.numeric(score_df_noNAs$approx_cont),
          ...
          xlab = "FS approximate (continuous)",
          ylab = "FS approximate (ordinal)",
          "[No NAs] Correlation of FS: approx. (cont.; M5) or approx. (ord.; M7)"))
