...
```{r}
if (!file.exists("rds/score_df_noNAs.rds")) {
...
if(!exists("d_noNAs") | !exists("fit_partial_noNAs")) { # if knitting for the second time, repeatAnalysesNoNAs not run, so we read in files for the following objects 
